function [Dtest,modelF,allF]=spm_eeg_invertiter_slidingwindow(Dtest,Npatchiter,funcname,patchind)
...
n_wois=size(Dtest{1}.inv{1}.inverse.wois,1);
allF=zeros(n_wois,Npatchiter);
...
for patchiter=1:Npatchiter,
    ...
    switch funcname,
        case 'Classic',
            ...
            Dtest{1}    = spm_eeg_invert_classic_slidingwindow(Dtest{1});
        case 'Current',
